...
public class StudentService {
    ...
    public void addStudent(int id, String name, String email, String token, AuthService authService) throws SQLException {
    ...
    public void getStudent(int id, String token, AuthService authService) throws SQLException {
        if (!authService.validateToken(token)) throw new RuntimeException("Unauthorized");
    ...
    public void deleteStudent(int id, String token, AuthService authService) throws SQLException {
        if (!authService.validateToken(token)) throw new RuntimeException("Unauthorized");
